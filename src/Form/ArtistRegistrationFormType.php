...
class ArtistRegistrationFormType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('email', EmailType::class, [
                'label' => 'Email *',
                'attr'  => ['placeholder' => 'contact@monlabel.com'],
            ])
            ->add('plainPassword', RepeatedType::class, [
                'type'            => PasswordType::class,
                'mapped'          => false,
                'first_options'   => ['label' => 'Mot de passe *', 'attr' => ['placeholder' => '8 caractères minimum']],
                'second_options'  => ['label' => 'Confirmer le mot de passe *', 'attr' => ['placeholder' => 'Répétez']],
            ...
            ->add('agreeTerms', CheckboxType::class, [
                'mapped'      => false,
                'label'       => "J'accepte les conditions d'utilisation et la charte des artistes",
